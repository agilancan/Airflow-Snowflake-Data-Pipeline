...
S3_FILE_PATH = "s3://agilan-astrosdk"
...
with DAG(dag_id='astro_orders', start_date=datetime(2025, 1, 1), schedule='@daily', catchup=False) as dag:
    orders_data = aql.load_files(
        input_file=File(
    ...
    reporting_table = aql.merge(
        ...
        target_conflict_columns=["orders_id"],
